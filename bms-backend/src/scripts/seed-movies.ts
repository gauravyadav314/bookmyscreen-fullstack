...
const movies = [
  ...
  },
  {
    ...
    certification: "UA13+",
    duration: "3h 10m",
    posterUrl: "/avatar-fire-and-ash.jpg",
    releaseDate: new Date("2025-12-19"),
    description: "Jake Sully and Neytiri travel across Pandora to face a fiery new clan of Na'vi.",
    format: ["2D", "3D", "IMAX 3D"]
  },
  {
    ...
    certification: "UA16+",
    duration: "3h 20m",
    posterUrl: "/pushpa-2.png",
    releaseDate: new Date("2025-08-15"),
    description: "Pushpa Raj expands his red sandalwood empire while facing ruthless opponents and law enforcement.",
    format: ["2D", "IMAX"]
  },
  {
    ...
    certification: "A",
    duration: "2h 08m",
    posterUrl: "/deadpool-wolverine.png",
    releaseDate: new Date("2025-07-26"),
  ...
  },
  {
    ...
    posterUrl: "/kalki.png",
    releaseDate: new Date("2025-06-27"),
    description: "A modern avatar of Vishnu descends to Earth to protect humanity from dark forces in Kasi.",
    format: ["2D", "3D", "IMAX 3D"]
  },
  {
